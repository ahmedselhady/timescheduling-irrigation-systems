...
# def knapsack_with_tolerance_maxitems(weights, values, capacity, max_items):
#     n = len(weights)
#     capacity = math.ceil(capacity)
...
#     # Check if the number of selected items exceeds the maximum allowed
#     if len(selected_weights) > max_items:
#         # Remove the last item until the number of selected items is less than or equal to the maximum allowed
#         while len(selected_weights) > max_items:
#             last_item = selected_weights.pop()
